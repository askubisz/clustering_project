...
datasets = [('dense', {"n_clusters": 2, "min_samples": 5, "min_cluster_size": 7, "min_samples_hdbscan": 3, "eps": 0.1, "n_neighbors": 4, "denmune_neigh": 24, "classix_minpts": 24, "classix_radius": 0.31, "quantile": 0.345}),
            ('fuzzyx', {"n_clusters": 5, "min_samples": 13, "min_cluster_size": 29, "min_samples_hdbscan": 3, "eps": 0.14, "n_neighbors": 5, "denmune_neigh": 12, "classix_minpts": 7, "classix_radius": 0.03, "quantile": 0.165}),
            ('line', {"n_clusters": 2, "min_samples": 8, "min_cluster_size": 4, "min_samples_hdbscan": 3, "eps": 0.08, "n_neighbors": 5, "denmune_neigh": 12, "classix_minpts": 3, "classix_radius": 0.19, "quantile": 0.216}),
            ('parabolic', {"n_clusters": 2, "min_samples": 14, "min_cluster_size": 21, "min_samples_hdbscan": 6, "eps": 0.23, "n_neighbors": 5, "denmune_neigh": 20, "classix_minpts": 11, "classix_radius": 0.09, "quantile": 0.319}),
            ('ring_noisy', {"n_clusters": 2, "min_samples": 3, "min_cluster_size": 3, "min_samples_hdbscan": 6, "eps": 0.11, "n_neighbors": 8, "denmune_neigh": 16, "classix_minpts": 3, "classix_radius": 0.21, "quantile": 0.345}),
            ('ring_outliers', {"n_clusters": 2, "min_samples": 3, "min_cluster_size": 4, "min_samples_hdbscan": 3, "eps": 0.11, "n_neighbors": 9, "denmune_neigh": 17, "classix_minpts": 3, "classix_radius": 0.13, "quantile": 0.216}),
            ('ring', {"n_clusters": 5, "min_samples": 12, "min_cluster_size": 4, "min_samples_hdbscan": 3, "eps": 0.1, "n_neighbors": 7, "denmune_neigh": 19, "classix_minpts": 3, "classix_radius": 0.17, "quantile": 0.319}),
            ('zigzag_noisy', {"n_clusters": 3, "min_samples": 5, "min_cluster_size": 8, "min_samples_hdbscan": 5, "eps": 0.26, "n_neighbors": 17, "denmune_neigh": 15, "classix_minpts": 3, "classix_radius": 0.36, "quantile": 0.164}),
            ('zigzag_outliers', {"n_clusters": 3, "min_samples": 9, "min_cluster_size": 16, "min_samples_hdbscan": 3, "eps": 0.14, "n_neighbors": 9, "denmune_neigh": 12, "classix_minpts": 15, "classix_radius": 0.29, "quantile": 0.139}),
            ('zigzag', {"n_clusters": 3, "min_samples": 10, "min_cluster_size": 5, "min_samples_hdbscan": 3, "eps": 0.19, "n_neighbors": 6, "denmune_neigh": 10, "classix_minpts": 3, "classix_radius": 0.35, "quantile": 0.139}),
            ]
...
for i_dataset, (dataset, params) in tqdm(enumerate(datasets)):
    data=clustbench.load_dataset('graves', dataset)
...
df_extrinsic.to_csv('graves_extrinsic.csv')
df_intrinsic.to_csv('graves_intrinsic.csv')